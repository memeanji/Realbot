...
# 비용이 많이 드는 작업을 캐시하기 위한 함수
@st.cache_data
def expensive_computation():
    # 실제 계산 코드 또는 외부 데이터 불러오기
    result = some_expensive_task()  # 예시로 비싼 작업
    return result
...
def get_response(user_input):
    responses = {
        ...
        r"김다영|다영|다영cp|김다영 cp": "다영 CP님은 영어 3cell에서 동계 연수 중이고 지나가다 마주치면힐링될 정도의 미친 외모를 담당 중이여오📚❄️✨\n 뿐만 아니라,말도 어찌나 예쁘게 하는지 듣기만 해도 기분이 몽글몽글💬💕\n게다가 알잘딱갈센으로다가 일까지 완벽하게 해내는✨ 갓벽 CP님👏🔥",
        ...
        r"김태희|태희|태희cp|김태희 cp": "태희CP님은 앱서비스 Cell에서 활약 중이시고,중국어, 노래 듣기, 춤까지 다재다능한 취미를 가진 매력 만점 CP님이에요!🎶🕺✨\n아직 대화를 나누진 못했지만, 감각적이고 흥 넘치는 분위기가 기대되는 분이에요! 😆💖",
        ...
        r"문지영|지영|지영cp|문지영 cp": "지영 CP님은 앱서비스 Cell에서 동계 연수 중이시고,중국어, 춤, 그리고 인디게임까지! 다채로운 취미를 지닌 CP님이에요! 🕺🎮🌏\n세련된 감각과 개성 넘치는 스타일이 기대되는 분,지영 CP님과 함께라면 새로운 세계가 열릴 것만 같은 느낌이에요! 😆🔥",
        ...
        r"서예지|예지|예지cp|서예지 cp": "예지CP님은 에듀테크콘텐츠 2Cell에서 동계 연수 중이시고,피아노 연주와 K-POP을 사랑하는 감성 충만 CP님이에요!\n 🎹🎶✨따뜻한 멜로디와 트렌디한 감각을 겸비한 예지 CP님의 플레이리스트가 궁금해지는 순간! 💖",
        ...
        r"송혜빈|혜빈|혜빈cp|송혜빈 cp": "혜빈 CP님은창의융합콘텐츠 1Cell에서 동계 연수 중이시고,뮤지컬과 국내 여행을 즐기시는 열정 가득한 CP님이에요!🎭✈️💫\n화려한 무대와 새로운 곳을 탐험하는 설렘이 가득한 분,함께라면 일상도 한 편의 뮤지컬처럼 빛날 것 같아요! 🎶✨",
        ...
        r"유혜진|혜진|혜진cp|유혜진 cp": "혜진 CP님은 초등국어교과서 Cell에서 동계 연수 중이시고,피아노와 독서를 사랑하는 감성 충만 CP님이에요!🎹📖✨\n깊이 있는 책 한 권과 따뜻한 선율이 어울리는 분위기,혜진 CP님과 함께라면 마음까지 편안해질 것 같은 느낌이에요! 💖",
        ...
        r"이다원|다원|다원cp|이다원 cp": "다원 CP님은 사회 1 cell에서 동계 연수 중이고 😆재치 있는 입담과 유쾌한 장난기로 웃음바다를 만들지만,\n 중요한 순간엔 누구보다 집중력 있게 일도 척척 해내는 반전 매력의 소유자예요!\n 🔥사회cell의 연수생들 중 외모 2위를 담당하며, 1위 연수생의 외모를 질투하고 있어요",
        ...
        r"임서진|서진|서진cp|임서진 cp": "서진cp은 에듀테크콘텐츠 1Cell에서 동계 연수 중이시고,책을 사랑하는 지적인 CP님이에요!📖☕\n깊은 통찰력과 따뜻한 감성이 함께할 것 같은 서진 CP님 덕분에 함께 이야기 나누면 좋은 배움을 얻을 것 같은 느낌이에요! ✨",
        ...
        r"비상교육": "두 달 동안 라키비움 프로젝트를 진행하는 동안 라키비움 내 많은 자료들에 대해 많이 배울 수 있었습니다 ✨ 비상교육과 함께 했던 두 달의 소중한 기억을 마음에 새기며, 앞으로 더 나은 모습으로 성장해 나가겠습니다.<br> 연수기간 동안 함께해 주신 모든 분들께 감사드립니다 🙏 항상 건강하시고 행복하시길 바랍니다 🌸",
