...
def get_response(user_input):
    responses = {
        ...
        r"비상교육": "두 달 동안 라키비움 프로젝트를 진행하는 동안 라키비움 내 많은 자료들에 대해 많이 배울 수 있었습니다 ✨ 비상교육과 함께 했던 두 달의 소중한 기억을 마음에 새기며, 앞으로 더 나은 모습으로 성장해 나가겠습니다. 연수기간 동안 함께해 주신 모든 분들께 감사드립니다. 항상 건강하시고 행복하시길 바랍니다 🌸",
